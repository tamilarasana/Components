                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <h5>Html Code <button type="button" id="copy-btn" style="float:right;"
                                    onclick="myHtmlCopyFunction({{ $card->id }})">Copy text</button><span id="msg_{{ $card->id }}"
                                    style="color:green;"></span></h5>
                            @if (!empty($card->html))
                            <div>
                            <pre  class="text-content short-text" id="myInput_{{ $card->id }}">{{ $card->html }}
                            </pre>
                            <div>
                            <button onclick="myFunction()" href="#" class="read-more" id="myBtn">Read more</button>
                          </div>
                            @else
                            <pre>No Data Found </pre>
                            @endif
                            ...
                            <h5>Css Code <button type="button" id="copy-btn" style="float:right;"
                                    onclick="myCssCopyFunction({{ $card->id }})">Copy text</button><span id="Cssmsg_{{ $card->id }}"
                            ...
                            <h5>Java Script Code <button type="button" id="copy-btn" style="float:right"
                                    onclick="myJsCopyFunction({{ $card->id }})">Copy text</button><span id="Jsmsg_{{ $card->id }}"
                                    style="color: green;"></span></h5>
                            ...
                            <button onclick="myFunction()"
                                 class="read-more" href="#" id="myBtn">Read more</button>
                            </div>
                            @else
                            <pre>No Data Found</pre>
                            @endif
